...
<head>
  ...
  <script type="application/ld+json">{json.dumps({'@context': 'https://schema.org', '@type': 'Person', 'name': profile['name'], 'jobTitle': profile['headline'], 'url': SITE_URL, 'sameAs': [profile['github'], profile['linkedin']]}, ensure_ascii=False).replace('</', '<\\/')}</script>
</head>
<body>
